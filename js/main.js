jQuery(document).ready(function($){
	...
	Schedule.prototype.placeEvents = function() {
		var self = this;
		this.singleEvents.each(function(){
			//place each event in the grid so need to set top position and height
	...
	Schedule.prototype.openModal = function(event) {
		...
		//if browser do not support transitions so no need to wait for the end of it
	...
	Schedule.prototype.closeModal = function(event) {
		...
		//browser do not support transitions so no need to wait for the end of it
		if( !transitionsSupported ) self.modal.add(self.modalHeaderBg).trigger(transitionEnd);
	}

	Schedule.prototype.mq = function(){
		//get value ('desktop' or 'mobile') 
		var self = this;
